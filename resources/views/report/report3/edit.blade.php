...
<section class="section">
    ...
    <div class="section-body">
        ...
        <div class="card">
            <form method="POST" action="{{ route('report3.update', $input3->id) }}" id="myForm" enctype="multipart/form-data">
                ...
                <div class="card-footer text-right">
                    ...
                    <a class="btn btn-secondary" href="{{ route('report3.index') }}">Cancel</a>
                </div>
            </form>
        </div>
    </div>
